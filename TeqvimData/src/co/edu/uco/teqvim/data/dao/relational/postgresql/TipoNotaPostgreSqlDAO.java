...
import co.edu.uco.teqvim.crosscutting.utils.Messages.TipoNotaPostgresSqlDAOMessages;
...
public final class TipoNotaPostgreSqlDAO extends SqlDAO<TipoNotaEntity> implements TipoNotaDAO {
	...
	protected String prepareFrom() {
		return "FROM tipo_nota ";
	}

	@Override
	protected String prepareWhere(TipoNotaEntity entity, List<Object> parameters) {
	...
	@Override
	protected List<TipoNotaEntity> executeQuery(PreparedStatement preparedStatement) {

		final List<TipoNotaEntity> result = new ArrayList<>();
